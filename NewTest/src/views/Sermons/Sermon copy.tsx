      ...
      <Card>
        <div className="pb-0 pt-5">
          <CardContent className="">
			...
			{sermonFull.length > 0 &&
                  sermonFull[0].SeriesType.image_path && (
                    <SiteImage
                      divClass="h-60"
                      ratio={16 / 9}
                      alt="Series Image"
                ...
                <div className="pt-2">
                  <div className="leading-none pb-1 pl-4">
                    ...
                    <div className="flex text-center leading-tight pt-2">
                      <div className="flex flex-row items-center mx-auto">
                        <div className="text-center text-gray-400 leading-none text-sm  pr-1">
                          {month}
                        </div>
                        <div className="text-center text-gray-400 text-sm  leading-none">
                          {day}
                        </div>
                        <div className="text-center text-gray-400 leading-none text-sm pl-1">
                          {year}
                        </div>
                      </div>
                    </div>
